...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!validateUsername(normalizedUsername)) {
      toast.error('Kullanıcı adı 3-20 karakter, sadece harf/rakam/alt çizgi olmalı');
      return;
    }
    ...
    try {
      ...
      if (!res.ok) throw new Error(data.error ?? t('error.usernameExists'));
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-2">
              ...
              />
              <p className="text-xs text-muted-foreground">3-20 karakter, a-z, 0-9, _</p>
            </div>
            <div className="space-y-2">
